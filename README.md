...
**Current spec version:** [v0.29.0](CHANGELOG.md)
...
| [0041](proposals/0041-observability-langfuse-metadata-key-collision.md) | Draft | observability §3.4 + §8.4 | Reserve OA-emitted Langfuse metadata key names so caller-supplied metadata can't silently overwrite them — both key sets stay top-level and filterable |
