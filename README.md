...
**Current spec version:** [v0.39.0](CHANGELOG.md)
...
| [0048](proposals/0048-read-symmetric-invocation-metadata-queryable-observer.md) | Draft | observability §3.4 + new §9 *Three-channel data-access guidance* | Read-symmetric invocation metadata + queryable observer pattern — symmetric read API for caller-supplied metadata; non-normative pattern for accumulator-style observers |
