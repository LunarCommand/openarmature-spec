...
**Current spec version:** [v0.40.0](CHANGELOG.md)
...
| [0049](proposals/0049-typed-llm-completion-event.md) | Draft | graph-engine §6 + observability §3 | Typed `LlmCompletionEvent` — adds a typed event variant alongside `NodeEvent` for in-graph LLM completions; framework-emitted observer-event mechanism for typed-event extension |
