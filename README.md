...
One proposal is in flight as a Draft: [0088](proposals/0088-observability-langfuse-parallel-branches-parity.md) (Langfuse parallel-branches mapping parity). New work opens as a numbered Draft proposal under [`proposals/`](proposals/).
