...
**Current spec version:** [v0.35.0](CHANGELOG.md)
...
| [0044](proposals/0044-parallel-branches-dispatch-span.md) | Draft | graph-engine §6 + observability §5 / §4 / §6 | Parallel-branches dispatch span synthesis — `parallel_branches_config` on NodeEvent (mirrors 0013's `fan_out_config`); new §5.7 attrs + observer synthesis behavior so OTel matches the Langfuse per-branch dispatch span shape (fixture 030) |
