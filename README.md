...
**Current spec version:** [v0.18.1](CHANGELOG.md)
...
| [pipeline-utilities](spec/pipeline-utilities/spec.md) | 0.5.0 | 0.18.1 | 53 | Middleware (canonical retry + timing), parallel fan-out, checkpointing (per-instance fan-out resume, state migration, configurable backend batching for fan-out internal saves), parallel branches |
