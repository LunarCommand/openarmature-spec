...
|---|---|---|---|
| [0125](proposals/0125-invariant-predicate-vocabulary.md) | Draft | conformance-adapter §5.9, §9 | Give the obligation to implement an invariant predicate a failure mode, since an unimplemented name is silently skipped and its fixture reports a pass; 924 of 934 predicate names in the corpus have no definition anywhere |
...
| [0123](proposals/0123-case-level-subgraph-declaration.md) | Draft | conformance-adapter §5.4 | Sanction declaring a subgraph inside a case as well as at the document top level, which 18 shipped fixtures already do and the directive vocabulary does not admit |
