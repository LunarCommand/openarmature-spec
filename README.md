...
**0083** (per-prompt token-budget observability) is currently in Draft; every other numbered proposal is
Accepted. New work opens as a numbered Draft proposal under [`proposals/`](proposals/).
