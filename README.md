...
| [0040](proposals/0040-observability-mid-invocation-metadata-open-span-update.md) | Draft | observability §3.4 + §6, graph-engine §6 | Mid-invocation metadata augmentation MUST reach open spans in the augmenting context — §3.4 SHOULD→MUST scoped to the augmenting async context's own open spans, plus a §6 augmentation-event mechanism |
