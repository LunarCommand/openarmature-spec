...
**Current spec version:** [v0.28.0](CHANGELOG.md)
...
| [0041](proposals/0041-observability-langfuse-metadata-namespacing.md) | Draft | observability §8.4 + §3.4 | Namespace OA-emitted Langfuse metadata under `metadata.openarmature` — fixes the caller-key vs OA-key collision in flat metadata while keeping caller keys top-level and filterable |
