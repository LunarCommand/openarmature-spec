...
**Current spec version:** [v0.34.0](CHANGELOG.md)
...
| [0043](proposals/0043-observability-langfuse-trace-input-output.md) | Draft | observability §8.4.1 + §8.9 | §8 Langfuse `trace.input` / `trace.output` population — three-lever design (privacy knob symmetric to `disable_llm_payload`, default-off minimal stub, optional caller hooks for domain summaries) |
