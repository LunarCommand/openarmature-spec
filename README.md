...
| [pipeline-utilities](spec/pipeline-utilities/spec.md) | 0.5.0 | 0.11.0 | Middleware (canonical retry + timing), parallel fan-out, checkpointing, parallel branches |
...
| [0014](proposals/0014-pipeline-utilities-state-migration.md) | Draft | pipeline-utilities §10 | State migration hooks for checkpoint records (activates `schema_version` + migration registry) |
