...
| [pipeline-utilities](spec/pipeline-utilities/spec.md) | 0.5.0 | 0.105.0 | 77 | Middleware (canonical retry + timing + failure isolation), parallel fan-out (per-instance + nested-fan-out resume with success/error discrimination + state migration), checkpointing (shares persistence with suspension), parallel branches. |
