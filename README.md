...
|---|---|---|---|
| [0122](proposals/0122-declared-field-collision-reachability.md) | Draft | llm-provider §6; retrieval-provider §8.4 | State that a declared-field extras collision is reachable only where the mapping renames the field on the wire, retire and repoint the two fixtures that pin unreachable instances, and make the malformed-element test structural rather than a vocabulary check |
