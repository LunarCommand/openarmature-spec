...
| [0033](proposals/0033-prompt-management-surface-refinements.md) | Prompt-management surface refinements (`Prompt.sampling`, `LabelResolver`, filesystem sidecar) | prompt-management | Draft    | —               | —          |
