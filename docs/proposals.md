...
|------|---------------------------------------------|---------------------|----------|-----------------|------------|
| [0117](proposals/0117-payload-leak-invariant-channels.md) | Broaden the Langfuse payload-leak invariant to all harvested-payload channels | observability | Draft    | —               | —          |
