...
`ChatTurnOutcome.suspended.pending_messages`.
...
- `.pending_messages` carries the assistant message the graph appended
...
- `.pending_messages` is empty when the graph appended one — would mean
