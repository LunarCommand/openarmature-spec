...
Verifies §10 determinism. The graph-engine §5 determinism guarantee covers the §6 event stream
...
- §10 Determinism — span hierarchy, names, attributes (minus timing), and status are reproducible.
- §10 Carve-outs — `trace_id`, `span_id`, `invocation_id`, auto-generated `correlation_id`, and
